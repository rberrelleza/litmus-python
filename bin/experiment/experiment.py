...
def main():
	...
	parser.add_argument("-kubeconfig", required=False, default="", dest='kubeconfig', help="Kubernetes client ignore SSL")
	...
	if args.name == "pod-delete":
		...
		logging.warning("Unsupported -name %s, please provide the correct value of -name args", args.name)
	return
